...
# Arc 1: Basic Commands — STATIC VISUAL VERSION (v2.0)
...
## Video 0: Welcome to Programming

**Duration:** ~130 seconds
**Purpose:** Inspiration + demystifying programming
...
- Simple background hinting at a futuristic interface (subtle grid or glow, not cluttered).
- Small subtitle: "Arc 1: Basic Commands".
...
### [SLIDE 2: What Is Programming, Really?]
...
- In the center or top: short caption "All powered by code".
- Clean, dark or neutral background to make icons pop.
...
### [SLIDE 3: The Superpower You're About to Get]
...
- Split screen:
    - Left: Person at a desk doing a boring repetitive task (e.g., renaming files manually).
    - Right: Same person relaxed (feet up, headphones on) while a screen shows code running/completing a task.
- Small caption on right: "Code does the boring stuff."
...
- Beneath, a row of big company logos: YouTube, Instagram, Spotify, Netflix, Dropbox.
- Small caption: "Used everywhere. Simple enough to start."
...
### [SLIDE 5: You Don't Need to Be a Genius]
...
- Split comparison:
    - Left: A normal recipe card ("Crack two eggs", "Mix", etc.) with a human cook doing the right thing.
    - Right: Same recipe interpreted literally by a goofy "computer chef" character cracking eggs on the floor because the bowl wasn't specified.
- Small caption: "Computers need ultra-specific instructions."
...
### [SLIDE 6: How This Actually Works]
...
### [SLIDE 7: You WILL Break Things (And That's Perfect)]
...
### [SLIDE 8: Your Journey Starts Ridiculously Simple]

**Visual Main:**

```text
Today: print("Hello")
Next Week: Real Logic
Soon: Real Programs
```
...
- Simple left-to-right progression bar or timeline:
    - Step 1: "print('Hello')" (tiny code snippet).
    - Step 2: "If/else, loops" (icon for logic).
    - Step 3: "Apps people can use" (phone/computer icon).
...
- Big, clear "Run Code" button below or beside the code.
- Output area showing `Hello, World!` once the button is pressed.
...
**Concept:** The `print()` function displays output to the terminal
...
- Simple terminal icon underneath the title, hinting at output to screen.
- Clean, dark background with a subtle grid.
...
- Split screen:
    - Left: simple code editor pane labeled "Code".
    - Right: black terminal pane labeled "Terminal" with example text lines.
- Short caption: "Code in the editor → Results in the terminal".
...
- Right: terminal showing `Welcome to CyberStrike`.
- Small "Run" button near code, arrow pointing from code to output.
...
- Right: terminal output with three lines, in the same order.
- Subtle arrows from each code line to its matching output line.
...
- Small caption: "One print() → one line."
...
### [SLIDE 6: Why Quotes Aren't Optional]

**Visual Main:**

```python
print("Access granted")   # ✓ WORKS
...
- Right: incorrect line with red X and an error bubble ("NameError" style).
- Tiny caption: "Quotes tell Python it's just text."
...
### [SLIDE 7: Single or Double—Python Doesn't Care]
...
- Small note: `"..."` and `'...'` both work; choose one style.
...
- Code line in editor with missing parentheses.
- Terminal below showing the error: `SyntaxError: Missing parentheses in call to 'print'`.
- Arrow or highlight on `print "Access granted"` and on the error line.
...
- Terminal showing: `SyntaxError: unterminated string literal`.
- Arrow pointing at the missing closing quote location.
...
**Concept:** Why Python is strict and the four grammar rules
...
- Title centered.
- Icon of a "rulebook" or grammar book with a small Python logo.
- Neutral background with subtle code-like pattern.
...
### [SLIDE 2: Why Computers Don't Guess]
...
- Right: "DMV-style" bureaucratic form stamped REJECTED for a tiny mistake.
- Caption: "Humans use context. Computers don't."
...
### [SLIDE 3: What If Python DID Guess?]
...
- Bottom: three mini-scenes:
    ...
    - Empty bank account screen.
    - Caption: "Guessing gone wrong."
...
### [SLIDE 4: The Voice Assistant Problem]
...
- Small dialogue bubble sequence:
    - You: "Set alarm for 6 AM".
    - Assistant mishears: "Setting alarm for 6 PM."
- Panel showing you oversleeping with a clock at late morning.
- Boss with annoyed expression and speech bubble "Where were you?"
...
- Subtitle: "Case and spelling change meaning."
- A second line below showing `Print("hello")` with a big red X.
...
### [SLIDE 6: The Four Rules (Here They Come)]
...
### [SLIDE 7: Rule 1 – Case Sensitivity Is Real]

**Visual Main:**

```python
print("works perfectly")   # ✓
Print("sorry, who?")       # ✗ NameError
PRINT("never heard of you")# ✗ NameError
```
...
- Terminal box showing NameError for the second and third lines.
- Highlight on lowercase `print` as the "correct keyword".
...
### [SLIDE 8: Rule 2 – Quotes Must Match]
...
- Small note: "Start and end quote must be the same."
- Error bubble from mismatched line.
...
### [SLIDE 9: Rule 3 – Parentheses Are Mandatory]
...
- Error bubble near second line labeled "SyntaxError".
...
### [SLIDE 10: Rule 4 – Spelling Counts]
...
- Terminal error for each typo line (NameError).
- Small caption: "No autocorrect in Python."
...
**Concept:** Python executes code line by line, top to bottom
...
- Title centered.
- Simple vertical flowchart icon (Line 1 → Line 2 → Line 3).
- Clean background.
...
### [SLIDE 2: Sequential Execution Explained]

**Visual Main:**

```python
print("Step 1: Scanning system")
print("Step 2: Finding vulnerabilities")
print("Step 3: Launching exploit")
...
- Arrow pointing from top to bottom labeled "Execution order".
...
### [SLIDE 3: Output Appears in Order]
...
- Small caption: "Output mirrors code order."
...
- Right: Python code with prints in wrong order and a "celebration before action" vibe.
- Caption: "Python runs steps exactly as written."
...
### [SLIDE 5: Wrong Order = Nonsense]

**Visual Main:**

```python
print("Victory! We did it!")
...
- Terminal output showing the same order.
- Small timeline icon showing "Celebrate" happening first, then "Connect" last, with a confused emoji.
...
- Subtle green check next to the block.
...
**Concept:** Comments with `#` help you document code
...
- Title centered.
- Icon of a sticky note or annotation bubble attached to code lines.
...
### [SLIDE 2: Code With vs Without Comments]
...
- Right side labeled "With comments: instantly clearer".
...
### [SLIDE 3: What Are Comments?]

**Visual Main:**

```python
# This is a comment - Python completely ignores it
print("But Python definitely runs this")
```
...
- Terminal output showing only `But Python definitely runs this`.
...
### [SLIDE 4: The Sticky Note Analogy]
...
- Timeline arrow from "Today you" to "Future you", both looking at the same commented code.
...
### [SLIDE 5: Where Comments Go]

**Visual Main:**

```python
# Comment above code explains what's coming
print("Firewall disabled")

print("Accessing database")  # Comment at end of line
```
...
- Tiny labels: "Explain section" vs "Quick note".
...
- Explain WHY
- Warn about tricky code
- Describe complex parts
- Leave reminders
```
...
- Icon of a brain or lightbulb near "WHY".
...
### [SLIDE 7: Well‑Commented Code Example]
...
# Author: You
# Purpose: Basic startup sequence
...
- Terminal output on the side with the three printed lines.
...
### [SLIDE 8: The Commenting‑Out Trick]
...
**Concept:** Reading and understanding error messages
...
- Title centered.
- Icon of a red error triangle transforming into a magnifying glass (clue).
...
### [SLIDE 2: Errors Are Actually Good]
...
- Right panel: happy check next to "Code crashes immediately with error".
- Caption: "Errors stop hidden bugs."
...
- Right: GPS showing "Recalculating..." when the car turns wrong, with a corrected route.
- Caption: "Immediate corrections beat silent failure."
...
### [SLIDE 4: Anatomy of an Error Message – Detective Edition]
...
### [SLIDE 5: Error Type 1 – SyntaxError]
...
- Terminal error: `SyntaxError: Missing parentheses in call to 'print'`.
- Highlight on missing parentheses area.
...
### [SLIDE 6: Error Type 2 – NameError]
...
- Terminal: `NameError: name 'Print' is not defined. Did you mean: 'print'?`
- Arrow from error suggestion to correct lowercase `print`.
...
### [SLIDE 7: Error Type 3 – IndentationError]
...
- Terminal: `IndentationError: unexpected indent`.
- Arrow from error to the extra spaces.
...
### [SLIDE 8: How to Actually Fix Errors]
...
- In "Read the error": mini bullet notes "Line number", "Error type", "Arrow position".
...
### [SLIDE 9: Key Takeaway – Errors Are Your Partner]

**Visual Main:**

```python
# Errors ≠ Failure
# Errors = Detailed bug reports
# Location + Type + Message = Roadmap
```
...
- Beside it: icon of a detective with a magnifying glass over a red error symbol.
